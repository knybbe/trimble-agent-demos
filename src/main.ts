...
document.querySelector<HTMLDivElement>('#app')!.innerHTML = `
  <header class="site-header">
    <div class="site-header-inner">
      ...
      <nav class="nav-links">
        ...
        <a href="${BASE}clash/">Clash Explainer</a>
        <a href="${BASE}drawings/">Ask the Drawings</a>
  ...
  <main class="container">
    ...
    <div class="tool-grid">
      <a class="tool-card" href="${BASE}clash/" style="color:inherit">
      ...
      <a class="tool-card" href="${BASE}drawings/" style="color:inherit">
